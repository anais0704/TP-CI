 ...
 *
 * >>> DÉROULÉ DU TP :
 *   1) Laisser ce test COMMENTÉ pour le 1er push -> la CI doit être VERTE.
 *   2) Créer le secret PHOTOGRAPHER_API_KEY dans les settings GitHub (valeur au choix).
 *   3) DÉCOMMENTER ce test, push -> la CI vérifie que la clé est bien récupérée.
 *
